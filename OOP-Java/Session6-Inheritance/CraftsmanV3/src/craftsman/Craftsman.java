...
public class Craftsman {
    ...
    public static void playWithTriangle() {
        ...
        //t1 là tên tắt về 1 hình TG, nó đây ~~~ new Triangle()
        Triangle t1 = new Triangle("TÍA", "PINK", 3, 4, 5);
        t1.paint(); // của Cha chính chủ
        
        RightTriangle rt1 = new RightTriangle("MÁ", "YELLOW", 6, 8);
        ...
        // <--- TG một là hình TGV
        //đang xem TGV như là 1 TG, gọi theo tên tắt của TG
        //rt2 chấm xổ ra Cha, xưng dưới danh nghĩa Cha, tao là con đại  gia ...
        
        rt2.paint(); // xài Cha, nhưng lúc chạy thì..Ưu tiên chạy Con, do new con
        //           //Hù cha nhưng chạy con
        //           paint() cha để đó, con lo cho , ca bị qua mặt
    }
    
    public static void playwithChildClass() {
        Square s1 = new Square("TÍA", "PINK", 5.0);
        s1.paint(); // k mún núp bóng Ba, mún có bản sắc, tui là HV (dĩ nhiên là HCN)
                                                            //square kìa , m thể hiện
                                                            // k phải ba
        //vi diệu 1
